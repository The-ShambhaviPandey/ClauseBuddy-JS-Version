    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-purple-200 text-lg max-w-2xl mx-auto">
          Your AI-powered legal document analyzer. Upload contracts, get plain
          English summaries, and identify potential risks instantly.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {stats.map((stat, index) => {
          ...
          return (
            <Card
              key={index}
              className="bg-gray-900/50 border-purple-900/30 backdrop-blur-sm"
            >
